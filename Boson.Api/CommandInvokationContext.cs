...
namespace Boson.Api
{
    ...
    {
        public BosonAdminBase BosonInstance { get; private set; }
        ...
        public CommandInvokationContext(BosonAdminBase boson, Entity caller, BaseScript.ChatType chatType, string message)
        {
            BosonInstance = boson;
            Caller = caller;
            ChatType = chatType;
